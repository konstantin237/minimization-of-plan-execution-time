...
<html>
  ...
  <body>
    <main class="assignment">
      <h1 class="assignment__title">Задача о назначениях</h1>
      <form class="assignment-form" id="assignment-form">
        <div class="assignment-form__matrix-inputs">
          <div class="assignment-form__matrix-block">
            <label class="assignment-form__label" for="matrix-c-textarea">Матрица C (стоимости)</label>
            <textarea class="assignment-form__textarea" id="matrix-c-textarea" placeholder="Введите элементы матрицы через пробел, строки отделяйте переносами
...
3 2 5 7 9</textarea>
          ...
          <div class="assignment-form__matrix-block">
            <label class="assignment-form__label" for="matrix-t-textarea">Матрица T (времена)</label>
            <textarea class="assignment-form__textarea" id="matrix-t-textarea" placeholder="Введите элементы матрицы через пробел, строки отделяйте переносами
Например для матрицы 3x3:
1 2 3
4 5 6
7 8 9">7 6 5 2 7
...
7 8 5 3 1</textarea>
        ...
        <div class="assignment-form__params">
          <label class="assignment-form__label" for="salary-fund">Фонд зарплаты S:</label>
          <input class="assignment-form__input" id="salary-fund" type="number" name="S" min="0" value="33">
          <label class="assignment-form__label" for="t-type">Тип оптимизации T:</label>
          <select class="assignment-form__select" id="t-type" name="T">
            <option value="min" selected>min</option>
            <option value="max">max</option>
          </select>
          <label class="assignment-form__label" for="t-limit">Ограничение на T (Если в условии не указано, оставить пустым):</label>
          <input class="assignment-form__input" id="t-limit" type="number" name="T_limit" min="0" step="any">
          <label class="assignment-form__checkbox-label">
            <input class="assignment-form__checkbox" id="skip-increasing-time" type="checkbox" checked>Не считать время, если оно больше одного из предыдущих времен
          </label>
          <label class="assignment-form__checkbox-label">
